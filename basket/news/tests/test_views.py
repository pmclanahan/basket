...
class GetInvolvedTests(TestCase):
    def setUp(self):
        ...
        patcher = patch('basket.news.views.validate_email')
...
@patch('basket.news.views.validate_email', none_mock)
...
class SubscribeEmailValidationTest(TestCase):
    ...
    @patch('basket.news.views.validate_email')
...
class TestValidateEmail(TestCase):
    ...
    @patch('basket.news.utils.dj_validate_email')
