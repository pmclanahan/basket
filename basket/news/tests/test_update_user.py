...
from basket.news.tasks import update_user, UU_EXEMPT_NEW, UU_ALREADY_CONFIRMED
...
class UpdateUserTest(TestCase):
    ...
    @patch('basket.news.tasks.ExactTarget')
    ...
    @patch('basket.news.tasks.send_message')
    @patch('basket.news.tasks.get_user_data')
    @patch('basket.news.utils.newsletter_fields')
    @patch('basket.news.tasks.ExactTarget')
