...
from basket.news import models, tasks, views
from basket.news.backends.common import NewsletterException
from basket.news.models import Newsletter, APIUser
from basket.news.utils import look_for_user, get_user_data, SET, generate_token
...
class UpdateGetInvolvedTests(TestCase):
    def setUp(self):
        ...
        patcher = patch('basket.news.tasks.get_user_data')
        self.addCleanup(patcher.stop)
...
class TestLookForUser(TestCase):
    def test_subscriptions(self):
        ...
        with patch('basket.news.utils.ExactTargetDataExt') as et_ext:
            data_ext = et_ext()
...
class TestGetUserData(TestCase):
    ...
    def check_get_user(self, master, optin, confirm, error, expected_result):
        ...
        with patch('basket.news.utils.look_for_user') as look_for_user_mock:
    ...
    @patch('basket.news.utils.look_for_user')
...
class UserTest(TestCase):
    ...
    @patch('basket.news.utils.ExactTargetDataExt')
